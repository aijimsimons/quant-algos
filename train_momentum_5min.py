#!/usr/bin/env python3
"""Train momentum strategy on 5-minute Bitcoin data."""
...
def run_training():
    """Train momentum strategy with 5-minute data."""
    print("=" * 60)
    print("  5-MINUTE MOMENTUM TRAINING: Last Full Month")
    print("=" * 60)
    ...
    params = {
        ...
        'take_profit_pct': [0.025, 0.035, 0.05],
    ...
    # Save results
    output_path = Path("train_results") / "momentum_train_5min_last_month"
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 60)
    print("MOMENTUM TRAINING COMPLETE")
    print("=" * 60)
